...
const CourseManagement = () => {
    ...
    const [newCourse, setNewCourse] = useState({ name: '', description: '', resourcesUrl: '', trainingFieldId: '' });
    ...
    const handleSaveCourse = async () => {
        if (selectedCourse) {
            ...
            if (newCourse.name && newCourse.description && newCourse.resourcesUrl) {
                try {
                    ...
                    setNewCourse({ name: '', description: '', resourcesUrl: '', trainingFieldId: '' });
    ...
    value={newCourse.resourcesUrl}
    onChange={(e) => setNewCourse({ ...newCourse, resourcesUrl: e.target.value })}
/>
                <input
                    type="number"
