...
export default function Input({type='text',name,id,title,onChange,errors,onBlur,touched,disabled}) {
  return (
    <>
          <div className="form-floating mb-3 col-md-6 row justify-content-center align-items-center">
