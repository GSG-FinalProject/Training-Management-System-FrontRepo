...
export default function Login() {
  ...
  return (
    <section className="h-100 p-1" style={{backgroundColor: '#eee'}} >
          ...
          <div className="card-body">
            <div className="d-flex justify-content-center">
              <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-2">
                <p className="text-center h1 fw-bold head my-5 pt-5">Sign in</p>
                <form className="d-flex flex-column justify-content-center align-items-center align-content-center" id="registrationForm" onSubmit={formik.handleSubmit}>
